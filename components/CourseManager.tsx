          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden animate-fade-in-up max-h-[90vh] flex flex-col">
            ...
            <div className="p-6 space-y-4 overflow-y-auto">
              ...
              <div>
                ...
                <select
                  title="Chọn độ khó"
                  aria-label="Chọn độ khó khóa học"
              ...
              <div className="bg-emerald-50 p-4 rounded-lg border border-emerald-100">
                ...
                {generatedSyllabus && (
                  <div className="mt-2">
                    <label className="block text-xs font-medium text-emerald-700 mb-1">Generated Syllabus:</label>
                    <textarea
                      value={generatedSyllabus}
                      onChange={(e) => setGeneratedSyllabus(e.target.value)}
                      placeholder="Nội dung syllabus sẽ hiển thị ở đây..."
                      title="Chỉnh sửa syllabus được tạo"
