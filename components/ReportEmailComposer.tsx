            ...
            <div className="bg-white w-full max-w-2xl sm:rounded-2xl shadow-2xl transform transition-transform translate-y-0 pointer-events-auto flex flex-col max-h-[90vh]">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="font-semibold text-slate-800">{t('reports.email.title')}</h2>
                    </div>
                    <button onClick={onClose} className="p-2 hover:bg-slate-100 rounded-full text-slate-400" title={t('common.close')} aria-label={t('common.close')}>
                        <X className="w-5 h-5" />
                    </button>
                </div>
