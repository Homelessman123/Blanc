    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button title="Lọc người dùng" className="p-2 border border-gray-300 rounded-lg hover:bg-gray-50 text-gray-600">
            <Filter size={18} />
          </button>
        </div>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 animate-fade-in-up">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Broadcast Email cho Users</h3>
            </div>
            <button
              title="Đóng"
              onClick={() => {
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">Hỗ trợ HTML cơ bản: &lt;p&gt;, &lt;br&gt;, &lt;strong&gt;, &lt;em&gt;, &lt;ul&gt;, &lt;li&gt;, &lt;a&gt;</p>
            </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-4">
                      <img src={user.avatar} alt="" className="h-10 w-10 rounded-full border border-gray-200" />
                      <div>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className={`capitalize ${user.role === 'admin' ? 'text-purple-700 font-medium' : 'text-gray-700'}`}>
                        {user.role}
                      </span>
                    </div>
                  </td>
        ...
        <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 flex items-center justify-between">
          <span className="text-sm text-gray-500">Showing 1 to 5 of 243 entries</span>
          <div className="flex gap-2">
            ...
            <button className="px-3 py-1 border border-gray-300 rounded bg-white text-sm text-gray-600 hover:bg-gray-50">Next</button>
          </div>
        </div>
      </div>
    </div>
