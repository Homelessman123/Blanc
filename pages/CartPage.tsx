                ...
                {cartItems.map(item => (
                    <Card key={item.id} className="p-4 flex items-center gap-4">
                        ...
                        <div className="text-right">
                             <p className="font-bold text-lg text-sky-400">${item.price.toFixed(2)}</p>
                             <button onClick={() => removeFromCart(item.id)} className="text-gray-500 hover:text-red-500 mt-2">
                                <Trash2 size={18}/>
                             </button>
                        </div>
                    </Card>
